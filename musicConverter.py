...
#Fast
path =["Cleaned/Fast/Alone.mid","Cleaned/Fast/BlindingLights.mid","Cleaned/Fast/Circle.mid","Cleaned/Fast/CountingStars.mid","Cleaned/Fast/Grenade.mid","Cleaned/Fast/Megalovania.mid","Cleaned/Fast/Popstars.mid"] #change path by replace path
#R&B
